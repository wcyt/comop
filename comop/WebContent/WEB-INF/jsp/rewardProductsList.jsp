        ...
        <aside class="col-span-3 bg-gray-100 rounded-lg lg:col-span-2">
                    ...
                    <ul class="">
                        <li class="my-1">
                            <label class="inline-flex items-center">
                                <input type="checkbox" name="black" class="mx-3 text-blue-400 rounded-full color focus:outline-none">
                        ...
                        <li class="my-1">
                            <label class="inline-flex items-center">
                                <input type="checkbox" name="white" class="mx-3 text-blue-400 rounded-full color">
                        ...
                        <li class="my-1">
                            <label class="inline-flex items-center">
                                <input type="checkbox" name="gray" class="mx-3 text-blue-400 rounded-full color">
                        ...
                        <li class="my-1">
                            <label class="inline-flex items-center">
                                <input type="checkbox" name="red" class="mx-3 text-blue-400 rounded-full color">
                        ...
                        <li class="my-1">
                            <label class="inline-flex items-center">
                                <input type="checkbox" name="orange" class="mx-3 text-blue-400 rounded-full color">
                        ...
                        <li class="my-1">
                            <label class="inline-flex items-center">
                                <input type="checkbox" name="green" class="mx-3 text-blue-400 rounded-full color">
                        ...
                        <li class="my-1">
                            <label class="inline-flex items-center">
                                <input type="checkbox" name="blue" class="mx-3 text-blue-400 rounded-full color">
                        ...
                        <li class="my-1">
                            <label class="inline-flex items-center">
                                <input type="checkbox" name="purple" class="mx-3 text-blue-400 rounded-full color">
                        ...
                        <li class="my-1">
                            <label class="inline-flex items-center">
                                <input type="checkbox" name="pink" class="mx-3 text-blue-400 rounded-full color">
            ...
            <div class="my-8 border">
                ...
                <div class="flex justify-end mt-4">
                    <button type="button" class="px-3 mr-3 font-semibold text-blue-400 border border-blue-400 rounded-full focus:outline-none">クリア</button>
                    <button type="submit" class="px-3 mr-3 font-semibold text-white bg-blue-400 border rounded-full focus:outline-none">OK</button>
                </div>
            </div>
        </aside>
	                ...
	                <li class="flex flex-col w-64 transition duration-400 hover:bg-gray-100">
	                    ...
	                    <div class="p-4 ">
	                        ...
	                        <div tabindex="0" class="w-full collapse">
	                            ...
	                            <div class="collapse-content">${reward.reward_product_description}</div>
	                        </div>
	                    </div>
	                </li>
                </c:forEach>
...
<script>
    function uncheckAll() {
        const checkbox = document.getElementsByClassName("color");
