...
<body>
    ...
    <div class="grid h-screen grid-cols-12">
        <!-- Main -->
        <main class="col-span-12 lg:px-32 sm:px-4">
            <!-- Content -->
            <div class="text-center my-28">
                <p class="font-bold text-9xl">500</p>
                <p class="mt-3 text-4xl font-bold capitalize">internal server error</p>
                <p class="mt-4 text-2xl font-bold">アクセスしようとしたページは表示できませんでした。</p>
            </div>
            <!-- Content End -->
        </main>
        <!-- Main End -->
        <!-- Footer -->
        <footer class="bottom-0 col-span-12 mt-auto bg-gray-200 lg:px-32 sm:px-4">
