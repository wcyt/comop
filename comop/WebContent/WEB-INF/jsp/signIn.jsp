...
<body>
    ...
    <main id="main" class="grid grid-cols-12 mb-8 lg:px-32 sm:px-4">
        ...
        <!-- Login Text End -->
        <!-- Login Form -->
        <form class="container col-span-12 px-12 py-8 mx-auto mt-4 bg-gray-200 w-96 form-control rounded-3xl">
            ...
            <a href="" class="mt-4 text-sm font-bold text-center text-blue-400 hover:underline">はじめてご利用の方（新規会員登録）</a>
        </form>
        <!-- Login Form End -->
    </main>
    <!-- Main End -->
